 ...
 */
function buildInstrumentations(config: TelemetryConfig): Instrumentation[] {
...
export function initTelemetry(config: TelemetryConfig): void {
  ...
  console.log(
    `OpenTelemetry initialized for ${mergedConfig.serviceName} v${mergedConfig.serviceVersion}`
  );
}
