...
```typescript
import { initializeTelemetry, createTracer } from '@nauticalstream/sdk/telemetry';
...
```typescript
import { NauticalError, ErrorCode, ErrorSeverity } from '@nauticalstream/sdk/errors';
...
```typescript
import { createNatsClient, subscribe, publish } from '@nauticalstream/sdk/eventbus';
